<x-guest-layout>
    <div class="text-center mb-8">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Set New Password') }}</h2>
        <p class="text-gray-500 dark:text-gray-400 mt-2">{{ __('Please create a strong password for your account') }}</p>
    </div>
